...
<nav class="fixed top-0 left-0 w-full bg-white z-50 shadow-md transition-all duration-300">
    <div class="w-full px-6 md:px-10 py-4 flex justify-between items-center">
        ...
        <!-- Logout Button -->
        <?php if ($isLogado): ?>
            <a href="<?php echo $isAdmin ? 'admin_logout.php' : 'logout.php'; ?>" class="p-2.5 bg-red-500 hover:bg-red-600 rounded-full text-white transition-all shadow-lg" title="Sair">
